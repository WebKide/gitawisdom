/**
 * oracle-forms.js
 * Wisdom Oracle — Landing-page form logic (v1.0.10)
 *
 * Responsibilities:
...
import { displayVerse, displayHexagram } from './lightbox.js';
...
function initChapterSelect() {
  ...
  function selectOption(opt) {
    if (!opt) {
      ...
      selectedValue = null;
      trigText.textContent = 'Select a Wisdom Gītā Chapter here';
