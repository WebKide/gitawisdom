/**
 * lightbox.js
 * Wisdom Oracle — Lightbox / card UI controller (v1.0.10)
 *
 * Responsibilities:
...
function closeLightbox() {
  ...
  if (fromOracle) {
    ...
    import('./oracle-forms.js').then(({ openOracleCard }) => {
...
export {
  ...
  goPrev,
  setNavDisabled,
  initSwipe,  // ← NEW: exported so app.js can call it after DOM ready
};